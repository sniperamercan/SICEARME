    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>listado_actas_alta/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('listado_actas_alta/seteoImpresion'); ?>", top: true, iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("listado_actas_alta/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("listado_actas_alta/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("listado_actas_alta/consulta"); ?>",
                    success: function(data){
            ...
            function verObservaciones(nro_acta) {
                $.ajax({
                    type: "post",  
                    url: "<?php base_url(); ?>listado_actas_alta/verObservaciones",
            ...
            function verEntrega(nro_acta) {
                $.ajax({
                    type: "post",  
                    url: "<?php base_url(); ?>listado_actas_alta/verEntregas",
                    data: "nro_acta="+nro_acta,
                    success: function(data){
