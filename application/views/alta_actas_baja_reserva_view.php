...
<html lang="es">
        ...
        <script type="text/javascript">
            ...
            function altaActa() {
                ...
                $.ajax({
                    type: "post",  
                    dataType: "json",
                    url: "<?php base_url(); ?>alta_actas_baja_reserva/validarDatos",
            ...
            function cargoNroSeries(unidad) {
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoNroSeries",
                   data: "unidad="+unidad,
                   success: function(data) {
            ...
            function cargoMarcas(unidad, nro_serie) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoMarcas",
            ...
            function cargoCalibres(unidad, nro_serie, marca) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoCalibres",
            ...
            function cargoModelos(unidad, nro_serie, marca, calibre) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoModelos",
            ...
            function cargoMarcasAccesorios(unidad, nro_serie) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoMarcasAccesorios",
                   data: "unidad="+unidad+"&nro_serie="+nro_serie,
                   success: function(data) {
                       $("#marca_accesorio").html("");
            ...
            function cargoCalibresAccesorios(unidad, nro_serie, marca) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoCalibresAccesorios",
                   data: "unidad="+unidad+"&nro_serie="+nro_serie+"&marca="+marca,
                   success: function(data) {
                       $("#calibre_accesorio").html("");
            ...
            function cargoModelosAccesorios(unidad, nro_serie, marca, calibre) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoModelosAccesorios",
                   data: "unidad="+unidad+"&nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre,
                   success: function(data) {
                       $("#modelo_accesorio").html("");
            ...
            function cargoNroAccesorios(unidad, nro_serie, marca, calibre, modelo) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoNroAccesorios",
            ...
            function busquedaFichas() {
                ...
                if($("#unidad_entrega").val() != '') {
                    $.ajax({
                       type: "post",
                       url: "<?php base_url(); ?>alta_actas_baja_reserva/seteoUnidad",
            ...
            function cargoFichasFiltro() {
                ...
                $.ajax({
                   ...
                   dataType: "json",
                   data: "unidad="+unidad,
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoFichasFiltro",
                   success: function(data) {
                       $("#nro_serie").val("");
            ...
            function cargoAccesoriosFiltro() {
                ...
                $.ajax({
                   ...
                   dataType: "json",
                   data: "unidad="+unidad,
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/cargoAccesoriosFiltro",
                   success: function(data) {
            ...
            function agregarFicha() {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/agregarFicha",
                   data: "unidad="+unidad+"&nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo,
                   success: function(data) {
                       if(data[0] == 1) {
            ...
            function anularFicha(nro_serie, marca, calibre, modelo) {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/anularFicha",
            ...
            function agregarAccesorio() {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/agregarAccesorio",
            ...
            function anularAccesorio(nro_serie, marca, calibre, modelo, nro_accesorio) {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>alta_actas_baja_reserva/anularAccesorio",
    ...
    <body class="cuerpo">
        ...
        <div>			
            ...
            <h1> Alta de acta de baja (reserva) </h1>    
            ...
            <fieldset>	
                ...
                <dd><select id="unidad_entrega"> <option value="96"> Reserva </option> </select></dd> 					
                </dl>                
