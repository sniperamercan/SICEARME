    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>listado_acciones_ordenes_trabajo/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('listado_acciones_ordenes_trabajo/seteoImpresion'); ?>", iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("listado_acciones_ordenes_trabajo/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("listado_acciones_ordenes_trabajo/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function verInformacion(nro_accion) {
                ...
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>listado_acciones_ordenes_trabajo/verInformacion",
