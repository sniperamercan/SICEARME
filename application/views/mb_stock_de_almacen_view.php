        ...
        <script type="text/javascript">
            ...
            function editar(nro_parte, nombre_parte, nro_catalogo) {
                $.ajax({
                    ...
                    success: function(){
                        irAFrame('<?php echo base_url('modificar_stock_de_almacen'); ?>','Almacen >> Modificar/Anular >> Repuestos');
                    }                  
                });            
            }
            ...
            function ajustarStock(nro_parte, nombre_parte, nro_catalogo) {
                $.ajax({
                    ...
                    data: "nro_parte="+nro_parte+"&nombre_parte="+nombre_parte+"&nro_catalogo="+nro_catalogo,
                    success: function(){
                        irAFrame('<?php echo base_url('ajustar_stock_de_almacen'); ?>','Almacen >> Modificar/Anular >> Repuestos');
                    }                  
                });            
            }            
                 ...
                 jConfirm('Estas seguro que quieres eliminar dicho repuesto del almacen', 'ELIMINAR REPUESTO DEL ALMACEN', function(r) {
                    if(r) {           
                        $.ajax({
                            ...
                            success: function(data){
                                if(data == 1) {
                                    jAlert("El repuesto fue eliminado del stock del almacen", "ELIMINAR REPUESTO DEL ALMACEN", function() { irAFrame('<?php echo base_url('mb_stock_de_almacen'); ?>','Almacen >> Modificar >> Respuestos') } );
                                }else {
