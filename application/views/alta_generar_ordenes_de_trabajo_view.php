...
<html lang="es">
    ...
    <body class="cuerpo">
        ...
        <div>			
            ...
            <h1> Alta generar ordenes de trabajo </h1>    
            ...
            <fieldset>	
                ...
                <dl> 		
                <dt><label for="nro_registro"> Nro registro </label></dt>	
                ...
                <dl> 		
                <dt><label for="detalles"> Observaciones </label></dt>	
            ...
            <fieldset class="action">	
                <button style="margin-right: 20px;" onclick="altaCatalogo();"> Generar orden de trabajo </button>
            </fieldset>  
