    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>busqueda_repuestos_nro_pieza/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('busqueda_repuestos_nro_pieza/seteoImpresion'); ?>", top: true, iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_repuestos_nro_pieza/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_repuestos_nro_pieza/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function seleccion(nro_pieza, nro_catalogo, nro_parte, nombre_parte) {
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("busqueda_repuestos_nro_pieza/consulta"); ?>",
                    success: function(data){
            ...
            <table>
                ...
                <thead style='text-align: center; cursor: pointer;'>
                    <tr>      
                        ...
                        <th onclick="orderBy(3)"> Nro catalogo </th>
                        <th> Tipo arma    </th>
                        <th> Marca        </th>
                        <th> Calibre      </th>
                        <th> Modelo       </th>
