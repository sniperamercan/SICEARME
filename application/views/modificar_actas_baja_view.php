        ...
        <script type="text/javascript">
            ...
            function modificarActa() {
                ...
                $.ajax({
                    type: "post",  
                    dataType: "json",
                    url: "<?php base_url(); ?>modificar_actas_baja/validarDatos",
                    ...
                    success: function(data){
                        if(data[0] == "1"){            
                            jAlert("El acta fue modificada con exito", "Correcto", function() { irAFrame('<?php echo base_url('mb_actas_baja'); ?>','Abastecimiento >> Modificar >> Actas altas'); });
                        }else{
                            jAlert(data, "Error");
                        }                            
                  }
            ...
            function volverListado() {
                irAFrame('<?php echo base_url('mb_actas_baja'); ?>','Abastecimiento >> Modificar >> Actas bajas');
            }
            
            function cargoMarcas(nro_serie) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoMarcas",
            ...
            function cargoCalibres(nro_serie, marca) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoCalibres",
            ...
            function cargoModelos(nro_serie, marca, calibre) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoModelos",
            ...
            function cargoMarcasAccesorios(nro_serie) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoMarcasAccesorios",
                   data: "nro_serie="+nro_serie,
                   success: function(data) {
            ...
            function cargoCalibresAccesorios(nro_serie, marca) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoCalibresAccesorios",
                   data: "nro_serie="+nro_serie+"&marca="+marca,
                   success: function(data) {
            ...
            function cargoModelosAccesorios(nro_serie, marca, calibre) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoModelosAccesorios",
                   data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre,
                   success: function(data) {
            ...
            function cargoNroAccesorios(nro_serie, marca, calibre, modelo) {
                $.ajax({
                   type: "post",
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoNroAccesorios",
            ...
            function cargoFichasFiltro() {
                ...
                $.ajax({
                   ...
                   dataType: "json",
                   data: "unidad="+unidad,
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoFichasFiltro",
                   success: function(data) {
                       $("#nro_serie").html("");
            ...
            function cargoAccesoriosFiltro() {
                ...
                $.ajax({
                   ...
                   dataType: "json",
                   data: "unidad="+unidad,
                   url: "<?php base_url(); ?>modificar_actas_baja/cargoAccesoriosFiltro",
                   success: function(data) {
            ...
            function agregarFicha() {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>modificar_actas_baja/agregarFicha",
                   data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo,
                   success: function(data) {
                       if(data[0] == 1) {
            ...
            function anularFicha(nro_serie, marca, calibre, modelo) {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>modificar_actas_baja/anularFicha",
                   data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo,
                   success: function(data) {
                       if(data[0] == 1) {
            ...
            function agregarAccesorio() {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>modificar_actas_baja/agregarAccesorio",
            ...
            function anularAccesorio(nro_serie, marca, calibre, modelo, nro_accesorio) {
                ...
                $.ajax({
                   type: "post",
                   dataType: "json",
                   url: "<?php base_url(); ?>modificar_actas_baja/anularAccesorio",
                   data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo+"&nro_accesorio="+nro_accesorio,
                   success: function(data) {
                       if(data[0] == 1) {
    ...
    <body class="cuerpo">
        ...
        <div>			
            ...
            <fieldset>	
                ...
                <dd><select id="nro_serie" onchange="cargoMarcas($('#unidad_entrega').val(), this.value);"> <?php echo $nro_series; ?> </select> <img style="cursor: pointer;" onclick="busquedaFichas();" src="<?php echo base_url(); ?>images/search.png" /></dd> 					
                </dl>
                ...
                <dd><select id="nro_serie_accesorio" onchange="cargoMarcasAccesorios($('#unidad_entrega').val(), this.value);"> <?php echo $nro_series_accesorios; ?> </select> <img style="cursor: pointer;" onclick="busquedaAccesorios();" src="<?php echo base_url(); ?>images/search.png" /></dd> 					
                </dl>
