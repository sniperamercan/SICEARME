...
<html lang="es">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('consulta_disponibilidad_reserva/seteoImpresion'); ?>", iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 
