...
<html lang="es">
        ...
        <script type="text/javascript">
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("imprimir_ordenes_trabajo/consulta"); ?>",
                    success: function(data){
                        $("#contenido").append(data[0]);
    ...
    <body class="cuerpo">
        ...
        <div id="contenido">  <h1> Nro de orden de trabajo Nro - <?php echo $nro_orden; ?> </h1> </div>     
