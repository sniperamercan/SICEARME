    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>busqueda_fichas/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('busqueda_fichas/seteoImpresion'); ?>", top: true, iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function seleccion(nro_serie, marca, calibre, modelo) {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas/seteoSeleccion"); ?>",
                    data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo,
                    success: function(){
                        jAlert("Nro serie - "+nro_serie+", Marca - "+marca+", Calibre - "+calibre+", Modelo - "+modelo+" seleccionados", "SELECCION", parent.$.colorbox.close());                        
                    }                  
                });            
            }
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("busqueda_fichas/consulta"); ?>",
                    success: function(data){
