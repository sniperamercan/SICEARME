    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>busqueda_fichas_taller/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('busqueda_fichas_taller/seteoImpresion'); ?>", top: true, iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas_taller/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas_taller/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function seleccion(nro_serie, marca, calibre, modelo) {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_fichas_taller/seteoSeleccion"); ?>",
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("busqueda_fichas_taller/consulta"); ?>",
                    success: function(data){
