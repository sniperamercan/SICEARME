    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>consulta_stock_total_armas_detallado/consulta/0',
                    data: "unidad="+unidad,
                    success: function(){
                        cargoConsulta();
                    }
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('consulta_stock_total_armas_detallado/seteoImpresion'); ?>", iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("consulta_stock_total_armas_detallado/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("consulta_stock_total_armas_detallado/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("consulta_stock_total_armas_detallado/consulta"); ?>",
                    success: function(data){
                        if(data[0] != 0) {
