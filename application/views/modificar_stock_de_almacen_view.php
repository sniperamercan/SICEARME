...
<html lang="es">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function modificarStock() {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data == 1){            
                            jAlert("Stock de parte modificado correctamente en stock del almacen", "Correcto", function() { irAFrame('<?php echo base_url('alta_stock_de_almacen'); ?>','Almacen >> Modificar >> Respuestos'); });
                        }else{
                            jAlert(data, "Error");
                        }                            
                  }
            ...
            function volver() {
                irAFrame('<?php echo base_url('mb_stock_de_almacen'); ?>','Taller armamento >> Modificar >> Repuestos\n\
                ');
            }
    ...
    <body class="cuerpo">
        ...
        <div>			
            ...
            <fieldset>	
                ...
                <p class="subtituloform"> Modificar el catalogo al cual pertenece este armamento </p>
