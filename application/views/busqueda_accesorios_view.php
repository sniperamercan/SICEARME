    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                $.ajax({ 
                    type: 'post',
                    url: '<?php echo base_url(); ?>busqueda_accesorios/consulta/0',
            ...
            function impresion(){                
                $.colorbox({href:"<?php echo base_url('busqueda_accesorios/seteoImpresion'); ?>", top: true, iframe: false, scrolling: false, innerWidth: 800, innerHeight: 200, title: "IMPRESION"});                
            } 

            function seteoImpresion(de_pagina, a_pagina){                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_accesorios/armoImpresion"); ?>",
            ...
            function orderBy(param){            
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_accesorios/orderBy"); ?>",
                    data: "order="+param,
                    success: function(){
                        cargoConsulta();                       
                    }                  
            ...
            function seleccion(nro_serie, marca, calibre, modelo, nro_accesorio) {
                
                $.ajax({
                    type: 'post',
                    url: "<?php echo base_url("busqueda_accesorios/seteoSeleccion"); ?>",
                    data: "nro_serie="+nro_serie+"&marca="+marca+"&calibre="+calibre+"&modelo="+modelo+"&nro_accesorio="+nro_accesorio,
                    success: function(){
                        jAlert("Nro serie - "+nro_serie+", Marca - "+marca+", Calibre - "+calibre+", Modelo - "+modelo+" Nro accesorio - "+nro_accesorio+" seleccionados", "SELECCION", parent.$.fn.colorbox.close());                        
                    }                  
                });            
            }
            ...
            function cargoConsulta() {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: "<?php echo base_url("busqueda_accesorios/consulta"); ?>",
                    success: function(data){
            ...
            <table>
                ...
                <thead style='text-align: center; cursor: pointer;'>
                    <tr>      
                        ...
                        <th onclick="orderBy(6)"> Nro accesorio </th>
                    </tr>
                </thead>
