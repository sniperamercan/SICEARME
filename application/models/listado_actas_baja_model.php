...
class listado_actas_baja_model extends CI_Model {
    ...
    function eliminarActa($nro_acta) {
        ...
        $this->db->trans_start();
            ...
            $this->db->delete("actas_baja_devolucion_accesorios", $data_acta_where);
            $this->db->delete("actas_baja_devolucion_armamento", $data_acta_where);
            $this->db->delete("actas_baja", $data_acta_where);
    ...
    function activarActa($nro_acta, $datos_fichas, $datos_accesorios, $unidad_recibe) {
        ...
        $this->db->update("actas_baja", $data_acta_estado_set, $data_acta_estado_where);
