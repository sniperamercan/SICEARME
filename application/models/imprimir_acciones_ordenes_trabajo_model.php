...
class imprimir_acciones_ordenes_trabajo_model extends CI_Model {
    ...
    function consulta_db_acciones($nro_accion) {
        
        $result = array();

        $query = $this->db->query("SELECT d.fecha, d.seccion, d.tipo_accion
                                   ...
                                   AND d.nro_accion =".$this->db->escape($nro_accion)."
