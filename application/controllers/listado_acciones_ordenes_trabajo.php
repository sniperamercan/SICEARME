...
* Clase - listado_acciones_ordenes_trabajo
*/

class listado_acciones_ordenes_trabajo extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model('listado_acciones_ordenes_trabajo_model');
    ...
    function index() {
        ...
        $this->load->view("listado_acciones_ordenes_trabajo_view");
    }
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $config['total_rows'] = $this->listado_acciones_ordenes_trabajo_model->cantidadRegistros($condicion);
    ...
    function armoImpresion(){   
        ...
        }else if( $this->listado_acciones_ordenes_trabajo_model->cantidadRegistros($condicion) < (($a_pagina * 30) - 30) ){
            echo "No existe tal cantidad de paginas para esa consulta verifique";
        }else{
            echo "1";
            if( $this->listado_acciones_ordenes_trabajo_model->cantidadRegistros($condicion) <= 30 ){
                $ini   = 0;
                $param = 30;
    ...
    function verInformacion() {
        ...
        $tipo_accion = $this->listado_acciones_ordenes_trabajo_model->cargoTipoAccion($nro_accion);
    ...
    function verInformacionAccionSimple($nro_accion) {
        ...
        $datos = $this->listado_acciones_ordenes_trabajo_model->verInformacionAccionSimple($nro_accion);
    ...
    function verInformacionAccionSecundaria($nro_accion) {
        ...
        $datos = $this->listado_acciones_ordenes_trabajo_model->verInformacionAccionSecundaria($nro_orden, $nro_accion);
    ...
    function verInformacionAccionAsociada($nro_accion) {
        ...
        $datos = $this->listado_acciones_ordenes_trabajo_model->verInformacionAccionAsociada($nro_orden, $nro_accion);
