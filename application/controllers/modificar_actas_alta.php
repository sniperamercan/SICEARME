...
class modificar_actas_alta extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('modificar_actas_alta_model');
    ...
    function index() {
        ...
        $datos_fichas = $this->modificar_actas_alta_model->datosFichas($nro_acta);
        ...
        $datos_accesorios = $this->modificar_actas_alta_model->datosAccesorios($nro_acta);
    ...
    function cargoMarcas() {
        ...
        $marcas = $this->modificar_actas_alta_model->cargoMarcas($nro_serie);
    ...
    function cargoCalibres() {
        ...
        $calibres = $this->modificar_actas_alta_model->cargoCalibres($nro_serie, $marca);
     ...
     function cargoModelos() {
        ...
        $modelos = $this->modificar_actas_alta_model->cargoModelos($nro_serie, $marca, $calibre);
    ...
    function cargoMarcasAccesorios() {
        ...
        $marcas = $this->modificar_actas_alta_model->cargoMarcasAccesorios($nro_serie);
    ...
    function cargoCalibresAccesorios() {
        ...
        $calibres = $this->modificar_actas_alta_model->cargoCalibresAccesorios($nro_serie, $marca);
     ...
     function cargoModelosAccesorios() {
        ...
        $modelos = $this->modificar_actas_alta_model->cargoModelosAccesorios($nro_serie, $marca, $calibre);
     ...
     function cargoNroAccesorios() {
        ...
        $modelos = $this->modificar_actas_alta_model->cargoNroAccesorios($nro_serie, $marca, $calibre, $modelo);
