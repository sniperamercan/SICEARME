...
class imprimir_acta_baja extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('imprimir_acta_baja_model');
    ...
    function index() {
        ...
        $datos_fichas = $this->imprimir_acta_baja_model->datosFichas($nro_acta);
        ...
        $datos_accesorios = $this->imprimir_acta_baja_model->datosAccesorios($nro_acta);
