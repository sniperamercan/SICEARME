...
* Clase - mb_inventario_reserva
*/

class mb_inventario_reserva extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model('mb_inventario_reserva_model');
    ...
    function index() {
        ...
        $this->load->view("mb_inventario_reserva_view");
    }
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $result = $this->mb_inventario_reserva_model->consulta_db($param, $cantReg, $condicion, $order);
            ...
            */
            ...
            $concat .= "
                <tr class='".$class."'> 
                    ...
                    <td> ".$result[$i+3]." </td>
                    <td> ".$result[$i+4]." </td>
                    <td onclick='editarInventario(".$aux_nro_serie.", ".$aux_marca.", ".$aux_calibre.", ".$aux_modelo.");' style='text-align: center; cursor: pointer;'> <img src='".base_url()."images/edit.png' /> </td>
                </tr>
            ";
        ...
        $config['base_url'] = site_url("mb_inventario_reserva/consulta");
        $config['total_rows'] = $this->mb_inventario_reserva_model->cantidadRegistros($condicion);
    ...
    function armoImpresion(){   
        ...
        }else if( $this->mb_inventario_reserva_model->cantidadRegistros($condicion) < (($a_pagina * 30) - 30) ){
            echo "No existe tal cantidad de paginas para esa consulta verifique";
        }else{
            echo "1";
            if( $this->mb_inventario_reserva_model->cantidadRegistros($condicion) <= 30 ){
                $ini   = 0;
                $param = 30;
