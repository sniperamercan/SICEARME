...
class listado_catalogos extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view("listado_catalogos_view");
    }
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $result = $this->listado_catalogos_model->consulta_db($param, $cantReg, $condicion, $order);
        ...
        $config['base_url'] = site_url("listado_catalogos/consulta");
        $config['total_rows'] = $this->listado_catalogos_model->cantidadRegistros($condicion);
    ...
    function armoImpresion(){   
        ...
        }else if( $this->listado_catalogos_model->cantidadRegistros($condicion) < (($a_pagina * 30) - 30) ){
            echo "No existe tal cantidad de paginas para esa consulta verifique";
        }else{
            echo "1";
            if( $this->listado_catalogos_model->cantidadRegistros($condicion) <= 30 ){
                $ini   = 0;
                $param = 30;
