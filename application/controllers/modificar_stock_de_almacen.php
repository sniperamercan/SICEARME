    ...
    function validarDatos() {
        ...
        if(count($mensaje_error) > 0) {
            ...
            if($this->modificar_stock_de_almacen_model->existeParte($nro_parte, $nombre_parte, $nro_catalogo)) {
                $this->modificar_stock_de_almacen_model->actualizoStock($nro_parte, $nombre_parte, $precio, $cantidad, $nro_catalogo);
            }else {
                $this->modificar_stock_de_almacen_model->modificarStock($nro_parte, $nombre_parte, $precio, $cantidad, $nro_catalogo);
            }
