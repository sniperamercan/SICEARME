...
class listado_compras extends CI_Controller {
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $result = $this->listado_compras_model->consulta_db($param, $cantReg, $condicion, $order);
        ...
        $config['base_url'] = site_url("listado_compras/consulta");
        $config['total_rows'] = $this->listado_compras_model->cantidadRegistros($condicion);
    ...
    function armoImpresion(){   
        ...
        }else if( $this->listado_compras_model->cantidadRegistros($condicion) < (($a_pagina * 30) - 30) ){
            echo "No existe tal cantidad de paginas para esa consulta verifique";
        }else{
            echo "1";
            if( $this->listado_compras_model->cantidadRegistros($condicion) <= 30 ){
                $ini   = 0;
                $param = 30;
