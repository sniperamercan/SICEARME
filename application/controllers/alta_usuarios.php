<<<<<<< HEAD:application/controllers/agregar_usuario.php
<?php
...
class agregar_usuario extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('agregar_usuario_model');
    ...
    function index() {
        ...
        $this->load->view('agregar_usuario_view', $data);  
    }
...
?>
>>>>>>> :application/controllers/alta_usuarios.php
