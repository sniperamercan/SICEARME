...
* Clase - listado_repuestos_nro_pieza
*/

class listado_repuestos_nro_pieza extends CI_Controller {
    
    function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model('listado_repuestos_nro_pieza_model');
    ...
    function index() {
        ...
        $this->load->view('listado_repuestos_nro_pieza_view');  
    }
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $result = $this->listado_repuestos_nro_pieza_model->consulta_db($param, $cantReg, $condicion, $order);
        ...
        $config['base_url'] = site_url("listado_repuestos_nro_pieza/consulta");
        $config['total_rows'] = $this->listado_repuestos_nro_pieza_model->cantidadRegistros($condicion);
