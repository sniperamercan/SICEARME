...
* Clase - listado_ordenes_trabajo
*/

class listado_ordenes_trabajo extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model('listado_ordenes_trabajo_model');
    ...
    function index() {
        ...
        $this->load->view("listado_ordenes_trabajo_view");
    }
    ...
    function consulta($param="",$cantReg=30) {   
        ...
        $result = $this->listado_ordenes_trabajo_model->consulta_db($param, $cantReg, $condicion, $order);
            ...
            */
            ...
            $concat .= "
                <tr class='".$class."'> 
                    ...
                    <td onclick='imprimir(".$aux_nro_orden.");' style='text-align: center; cursor: pointer;'> <img src='".base_url()."images/eye.png' /> </td>
        ...
        $config['total_rows'] = $this->listado_ordenes_trabajo_model->cantidadRegistros($condicion);
    ...
    function armoImpresion(){   
        ...
        }else if( $this->listado_ordenes_trabajo_model->cantidadRegistros($condicion) < (($a_pagina * 30) - 30) ){
            echo "No existe tal cantidad de paginas para esa consulta verifique";
        }else{
            echo "1";
            if( $this->listado_ordenes_trabajo_model->cantidadRegistros($condicion) <= 30 ){
                $ini   = 0;
                $param = 30;
    ...
    function verObservaciones() {
        ...
        $observaciones = $this->listado_ordenes_trabajo_model->verObservaciones($nro_orden);
