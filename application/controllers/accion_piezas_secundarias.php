...
class accion_piezas_secundarias extends CI_Controller {
    ...
    function index() {
        ...
        //Cargo paises
        $array_paises = $this->accion_piezas_secundarias_model->cargoPaises();
        ...
        //Cargo catalogos
        $catalogos = $this->accion_piezas_secundarias_model->cargoCatalogos();
        ...
        //Cargo empresas
        $empresas = $this->accion_piezas_secundarias_model->cargoEmpresas();
